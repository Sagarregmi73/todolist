var todoList = {
  ...
  var view = {
    ...
    createDeleteButton: function(indexOfTodo, array){
      ...
      deleteButton.style.border="1px solid darkred"
    ...
    createToggleCompletedButton: function(todo){
      ...
      toggleButton.style.backgroundColor="darkblue"
      toggleButton.style.border="1px solid darkblue"
    ...
    createAddSubTodoButton: function(array){
      ...
      addSubTodoButton.style.backgroundColor="darkgreen"
      addSubTodoButton.style.border="1px solid darkgreen"
